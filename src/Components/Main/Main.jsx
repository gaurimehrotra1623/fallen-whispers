    ...
    <>
      <div className="main">
        ...
        <div className='main-explore'>
          ...
          <a href="#features"><img src={arrow} alt="" style={{ marginTop: "5px" }} /></a>
        </div>
        ...
        <div className="extra">
          <p>Warriors on the line between myth and memory. Shadows speak louder than words, and every step echoes a forgotten truth. As empires crumble and secrets rise, only the silent survive. The past isn’t dead — it’s waiting to be found.</p>
        </div>
      </div>

      <div className='storyline-section' ref={storylineRef} id='storyline'>
        <h1 style={{ marginBottom: "50px", fontSize: "50px", color:"goldenrod", textShadow: "0 0 8px rgba(218, 165, 32, 0.7)"}}>Storyline</h1>
        <p className='storyline-para'>
          Whispers once guarded the truth. Now, they echo through the ruins of empires.
          <br /><br />
          Long ago, a secret order known as The Silent Veil vanished, their legacy reduced to myth. In their absence, powerful forces rewrote history, burying forbidden truths beneath blood-stained scrolls and crumbling stone. But the past does not sleep forever.
          <br /><br />
          When an ancient relic resurfaces, the final heir of the Veil, Kael Adrastan, is thrust into a world unraveling at the seams. As kingdoms fall into chaos and forgotten gods stir beneath the surface, the last of the shadow-born must uncover what was meant to stay buried.
          <br /><br />
      ...
      <div className='contact-section' ref={contactRef} id='contact'>
        <h1 style={{ marginBottom: "50px", fontSize: "50px" ,color:"goldenrod", textShadow: "0 0 8px rgba(218, 165, 32, 0.7)"}}>Reach out to us!</h1>
        <div className="contact-icons">
          <a href="https://www.youtube.com/watch?v=ssrNcwxALS4" target="_blank" rel="noreferrer"><img src={youtube} style={{ height: "100px", width: "100px" }} alt="YouTube" /></a>
          <a href="https://unity.com/" target="_blank" rel="noreferrer"><img src={unity} style={{ height: "100px", width: "100px" }} alt="Unity" /></a>
          <a href="mailto:mvuo1awjjq1p@tmpwebmail.com">
            <img src={mail} style={{ height: "60px", width: "80px" }} alt="Mail" />
          </a>
        </div>
      </div>

      <div className='features-section' ref={featuresRef} id='features'>
        <h1 style={{ marginBottom: "50px", fontSize: "50px", color: "goldenrod", textShadow: "0 0 8px rgba(218, 165, 32, 0.7)" }}>
          Features
        </h1>
